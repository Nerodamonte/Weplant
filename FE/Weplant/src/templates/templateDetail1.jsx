          ...
          <div className="flex items-center gap-3">
            ...
            <Link
              ...
              className={`text-lg font-semibold ${
                theme === "dark" ? "text-green-50" : "text-green-900"
              }`}
            >
              Weplant
            </Link>
      ...
      <section className="pt-24 pb-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1">
            ...
            >
              Đưa người dùng trở về thập niên 80, 90 với phong cách hoài cổ,
              sang trọng và đầy cảm xúc. Thích hợp cho các dự án nghệ thuật, bảo
              tàng, và website mang dấu ấn thời gian.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className={`px-5 py-3 rounded-md ${
                  theme === "dark"
                    ? "bg-green-800/80 border border-green-700 text-green-50 hover:bg-green-900"
          ...
          <div
            className={`w-full md:w-96 rounded-2xl p-4 shadow-lg ${
              theme === "dark"
                ? "bg-gradient-to-b from-green-800 to-green-700 border-green-600"
                : "bg-gradient-to-b from-green-100 to-green-200 border-green-300"
            } border`}
          >
            <div
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className={`rounded-lg overflow-hidden h-56 flex items-center justify-center italic ${
                  theme === "dark"
            ...
            <ul className="mt-6 space-y-3">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  >
                    Tông màu xanh lá nhạt, typography retro.
                  </div>
                </div>
              </li>
        ...
        >
          ...
          <div className="mt-2 space-x-4">
            <a
              ...
              className={`${
                theme === "dark"
                  ? "text-green-300 hover:text-green-50"
                  : "text-green-600 hover:text-green-900"
              } hover:underline`}
            >
              Terms
