    ...
    >
        ...
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="flex-1">
            ...
            >
              ...
              với người dùng — tối ưu chuyển đổi, tốc độ tải nhanh và trải
              nghiệm mobile-first. Phù hợp cho startups, công ty công nghệ và
              agency.
            </p>
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              <a
                ...
                className={`px-5 py-3 rounded-md ${
                  theme === "dark"
                    ? "bg-gray-900/70 border border-gray-700 text-gray-100 hover:bg-gray-800"
            ...
            <ul
              className={`mt-6 grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm ${
          ...
          {/* Right: preview card */}
          <div
            className={`w-full md:w-96 rounded-2xl p-4 shadow-lg ${
              theme === "dark"
      ...
      <section id="features" className="py-12">
        <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          <div>
            ...
            >
              Template được thiết kế tập trung vào hiệu suất và chuyển đổi. Phù
              hợp cho đội ngũ kỹ thuật và marketing, dễ chỉnh sửa và mở rộng.
            </p>

            <ul className="mt-6 space-y-3">
              <li className="flex items-start gap-3">
                <span
                  className={`inline-block mt-1 w-8 h-8 rounded-md flex items-center justify-center text-sm ${
                    theme === "dark" ? "bg-gray-800" : "bg-gray-200"
                  }`}
                >
                  ⚡
                ...
                <div>
                  ...
                  >
                    Tối ưu hình ảnh, lazy load và CSS tối giản.
                  </div>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  >
                    Tương thích với hệ thống auth, JWT-ready.
                  </div>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  >
                    Trải nghiệm mượt trên mobile và tablet.
                  </div>
                </div>
              </li>
            </ul>
          ...
          >
            ...
            <div className="mt-6">
              <a
                href="#pricing"
                className={`inline-block px-4 py-3 rounded-md font-medium ${
                  theme === "dark"
                    ? "bg-white text-black"
      ...
      >
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            Chọn gói phù hợp cho dự án của bạn.
          </p>
          ...
          <div className="mt-8 grid md:grid-cols-3 gap-6">
            ...
            >
              ...
              >
                Gói phổ biến: full features, support.
              </p>
              <button
                className={`mt-4 w-full px-4 py-2 rounded-md ${
                  theme === "dark"
      ...
      >
        ...
        >
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between text-sm">
            ...
            >
              © {new Date().getFullYear()} Weplant. All rights reserved.
            </div>
