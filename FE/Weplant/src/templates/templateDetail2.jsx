      ...
      <section className="relative bg-gradient-to-r from-blue-600 to-cyan-500 text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Template website với gam màu xanh dương dịu nhẹ, tạo cảm giác thư
            thái và chuyên nghiệp.
          </p>
          ...
          <div className="flex flex-col items-center gap-8 text-center">
            <div>
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Với gam màu xanh dương mát mẻ lấy cảm hứng từ đại dương,
                template này mang đến sự thư thái cho người dùng. Phù hợp cho
                blog cá nhân, portfolio nghệ sĩ, hoặc website du lịch biển.
              </p>
              <ul className="space-y-2 mb-6 max-w-md mx-auto text-left">
                ...
                <li className="flex items-center gap-2 text-teal-600">
                  • Tích hợp dễ dàng với CMS
                </li>
                <li className="flex items-center gap-2 text-teal-600">
                  • Tốc độ load nhanh dưới 2s
                </li>
              </ul>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6 bg-white rounded-xl shadow-md">
              ...
              <p className="text-gray-600">
                Màu xanh dương dịu nhẹ giúp người dùng cảm thấy thoải mái khi
                duyệt web.
              </p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-md">
              ...
              <p className="text-gray-600">
                Tích hợp gallery ảnh biển xanh sống động, dễ dàng tùy chỉnh.
              </p>
            </div>
            <div className="text-center p-6 bg-white rounded-xl shadow-md">
              <div className="w-12 h-12 bg-teal-500 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">
                Code nhẹ, load nhanh, phù hợp cho mọi thiết bị.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            {[...Array(6)].map((_, i) => (
              <img
                key={i}
                src={`https://via.placeholder.com/400x300/87CEEB/4682B4?text=Ocean+Image+${
                  i + 1
                }`}
                alt={`Gallery ${i + 1}`}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-md">
              <p className="text-gray-600 mb-4">
                "Template này mang đến cảm giác biển cả tuyệt vời cho blog du
                lịch của tôi!"
              </p>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <p className="text-gray-600 mb-4">
                "Màu sắc mát mẻ, dễ tùy chỉnh. Rất hài lòng!"
              </p>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-teal-500 rounded-full"></div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-md">
              <p className="text-gray-600 mb-4">
                "Hoàn hảo cho portfolio nhiếp ảnh biển."
              </p>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-teal-500 rounded-full"></div>
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-cyan-500 text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <p className="text-xl mb-8">
            Hãy tạo dự án với template biển xanh này và biến ý tưởng thành hiện
            thực.
          </p>
          <Link
            to="/create-project"
